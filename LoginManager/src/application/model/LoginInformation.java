...
public class LoginInformation {
	...
	/**
	 * Initiliazed the fileName field. Once fileName has been set, all methods will look
	 * for this specific file to use.
	...
	/**
	 * <pre> Returns current username from the last time
	 * the findWebsite method was invoked.</pre>
	 * 
	...
	/**
	 * <pre> Returns current password from the last time 
	 * the findWebsite method was invoked.</pre>
	 * 
	...
	/**
	 * <pre> Looks to see if the website exist on file. If the website has
	 ...
	 * when reading through the file. </pre>
	 * 
	 * @param site - website to look for
	...
	/**
	 * <pre> Adds a new website, username and password to the end of file.
	 * Should call the findWebsite method first to be sure no duplicate information is being added.
	 * </pre>
	 * 
	 * @param site - new website to be added 
	...
	/**
	 * <pre> Updates the username and/or password for a website that's on file.
	 * Should call the findWebsite method first to be sure the website exist. If the website is found, 
	 * the website class field will have been initialized and then can be compared to websites on file.</pre>
	 * 
	...
	/**
	 * <pre> Deletes a website, username and password from file.
